...
class TeachersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create teacher" do
    assert_difference("Teacher.count") do
      post teachers_url, params: { teacher: { graduation: @teacher.graduation, person_id: @teacher.person_id } }
    end
  ...
  test "should update teacher" do
    patch teacher_url(@teacher), params: { teacher: { graduation: @teacher.graduation, person_id: @teacher.person_id } }
